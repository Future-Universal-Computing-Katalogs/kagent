...
│   │   ├── internal/controller/ # 11 controller files + translators
│   │   ├── internal/httpserver/ # REST API (handlers, auth, middleware)
│   │   ├── cli/                 # kagent CLI tool
│   │   └── test/e2e/            # E2E tests
...
│   │   ├── agentsts-adk/        # ADK-specific STS bindings
│   │   └── agentsts-core/       # RFC 8693 token-exchange client
│   └── samples/                 # Example agents (adk, crewai, langgraph, openai, sota)
...
11 controller .go files in `go/core/internal/controller/`:
- agent, sandboxagent, agentharness
- modelconfig, modelproviderconfig
- platformcredential
- remote_mcp_server, mcp_server_tool
- scheduledrun (+ scheduledrun_scheduler)
- service
