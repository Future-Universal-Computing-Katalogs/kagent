...
type PlatformAdapter interface {
	...
	// credNamespace is the namespace of the PlatformCredential and the Secret it references.
	Mint(ctx context.Context, source v1alpha2.CredentialSource, credNamespace string, principal Principal, scopes []string) (*Token, error)
