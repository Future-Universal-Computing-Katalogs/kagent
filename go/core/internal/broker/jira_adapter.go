...
func (a *JiraAdapter) Mint(ctx context.Context, source v1alpha2.CredentialSource, credNamespace string, principal auth.Principal, scopes []string) (*auth.Token, error) {
