...
import { OidcExpiryBanner, GithubExpiryBanner, JiraExpiryBanner } from "./TokenExpiryBanner";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
  ...
  return (
    <nav className="relative z-20 py-3 border-b bg-background/80 backdrop-blur-md">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        />
        <JiraExpiryBanner
          key={jiraTokenExpired ? "expired" : "ok"}
          jiraTokenExpired={jiraTokenExpired}
          rightSpacerWidth={rightControlsWidth}
        />
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
            ...
            <div className="flex items-center gap-2" ref={rightControlsRef}>
              <ConnectionsDropdown
                onGithubTokenExpired={setGithubExpiredLabels}
                onJiraTokenExpired={() => setJiraTokenExpired(true)}
                onOpen={() => { setGithubExpiredLabels([]); setJiraTokenExpired(false); }}
              />
              <ThemeToggle />
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
