...
function fromAgentFormDataToAgent(agentFormData: AgentFormData): Agent {
  ...
  if (type === "Declarative") {
    ...
    if (trimmedSA || (agentFormData.credentialMounts && agentFormData.credentialMounts.length > 0)) {
      base.spec!.declarative!.deployment = {
        ...base.spec!.declarative!.deployment,
        ...(trimmedSA ? { serviceAccountName: trimmedSA } : {}),
        ...(agentFormData.credentialMounts && agentFormData.credentialMounts.length > 0
          ? { credentialMounts: agentFormData.credentialMounts }
          : {}),
      };
    }
    ...
    base.spec!.byo = {
      deployment: {
        ...
        credentialMounts: agentFormData.credentialMounts && agentFormData.credentialMounts.length > 0
          ? agentFormData.credentialMounts : undefined,
      },
    };
  }
