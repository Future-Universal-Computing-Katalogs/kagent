...
| `packages/kagent-crewai` | kagent-crewai 0.1.0 | CrewAI framework integration |
...
| `packages/kagent-sota-adapter` | kagent-sota-adapter 0.1.0 | SOTA adapter (Claude Code, Codex) |
...
| `samples/crewai/*` | sample agents | CrewAI-based samples |
| `samples/langgraph/*` | sample agents | LangGraph-based samples |
| `samples/openai/*` | sample agents | OpenAI-based samples |
| `samples/sota/*` | sample agents | SOTA adapter samples (Claude Code, Codex) |
