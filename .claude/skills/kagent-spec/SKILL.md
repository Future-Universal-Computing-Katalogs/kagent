...
> **See also:** `kagent-docs` — documentation freshness checker for the architecture
> docs / READMEs / CHANGELOG. Use `kagent-docs` for top-level human-readable docs;
> use `kagent-spec` for the per-directory CLAUDE.md memory layer.
